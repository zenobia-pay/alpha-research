"""Direct Modal-volume addition for CFPB HMDA 2014 historic ZIPs."""
...
APP_NAME = "econ-direct-hmda-2014-historic"
DATASET_ROOT = Path("/data/datasets/econ")
RAW_DIR = DATASET_ROOT / "raw" / "hmda_2014_historic"
REFERER = "https://www.consumerfinance.gov/data-research/hmda/historic-data/"
FILES = [
    {
        "filename": "hmda_2014_nationwide_first-lien-owner-occupied-1-4-family-records_labels.zip",
        "url": "https://files.consumerfinance.gov/hmda-historic-loan-data/hmda_2014_nationwide_first-lien-owner-occupied-1-4-family-records_labels.zip",
        "source_key": "hmda_2014_historic_loan_records",
    },
    {
        "filename": "hmda_2014_transmittal_sheet.zip",
        "url": "https://files.consumerfinance.gov/hmda-historic-institution-data/hmda_2014_transmittal_sheet.zip",
        "source_key": "hmda_2014_historic_transmittal_sheet",
    },
    {
        "filename": "hmda_2014_panel.zip",
        "url": "https://files.consumerfinance.gov/hmda-historic-institution-data/hmda_2014_panel.zip",
        "source_key": "hmda_2014_historic_panel",
    },
]
...
def add_hmda_2014_historic() -> dict[str, object]:
    ...
    metadata = {
        "dataset_id": "econ",
        "source_key": "hmda_2014_historic",
        "title": "CFPB HMDA 2014 Historic Loan and Institution Data",
        "retrieved_at": retrieved_at,
...
def main() -> None:
    print(json.dumps(add_hmda_2014_historic.remote(), indent=2, sort_keys=True))
