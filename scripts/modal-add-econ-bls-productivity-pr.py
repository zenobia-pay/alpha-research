"""Modal-volume finalizer for BLS Labor Productivity and Costs `pr` files."""
...
APP_NAME = "econ-finalize-bls-productivity-pr"
DATASET_ROOT = Path("/data/datasets/econ")
RAW_DIR = DATASET_ROOT / "raw" / "bls_productivity_pr_20260115"
SOURCE_DIR = "https://downloadt.bls.gov/pub/time.series/pr/"
...
def finalize_bls_productivity_pr() -> dict[str, object]:
    ...
    for filename in FILES:
        ...
        record = {
            "source_key": "bls_productivity_pr",
    ...
    metadata = {
        "dataset_id": "econ",
        "source_key": "bls_productivity_pr",
        "title": "Bureau of Labor Statistics Labor Productivity and Costs `pr` time-series files",
        ...
        "file_roster_source": "Official BLS directory listing observed at https://downloadt.bls.gov/pub/time.series/pr/ on 2026-06-03; files were downloaded locally from explicit official URLs, uploaded with modal volume put, and finalized on the mounted volume.",
        "records": records,
        "notes": [
            "Provider-native BLS Labor Productivity and Costs `pr` flat files retained with original tab-delimited layouts.",
            ...
            "The package includes current and all-data observations plus class, duration, measure, period, seasonal, sector, series, footnote, contacts, and documentation files.",
        ],
    }
...
def main() -> None:
    print(json.dumps(finalize_bls_productivity_pr.remote(), indent=2, sort_keys=True))
