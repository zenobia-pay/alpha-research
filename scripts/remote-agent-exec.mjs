...
function datasetArtifactContractPrompt(promptText) {
  ...
  return [
    ...
    `DOCS_BRIEFING="$DATASET_DIR/docs/public-datasets/briefings/${datasetId}.md"`,
    ...
    `cp "$DATASET_DIR/docs/public-datasets/briefings/${datasetId}.md" "$RESULT_DIR/docs/public-datasets/briefings/${datasetId}.md" 2>/dev/null || true`,
    `cp "$DATASET_DIR/docs/public-datasets/${datasetId}.mdx" "$RESULT_DIR/docs/public-datasets/${datasetId}.mdx" 2>/dev/null || true`,
    "```",
    "",
