...
const requiredSources = ["FRED", "Fannie Mae", "FHFA", "BLS", "BEA", "Census", "Treasury"];
...
const prompt = [
  ...
  "Use real public sources including FRED, Fannie Mae, FHFA, BLS, BEA, Census, and Treasury.",
...
async function main() {
  ...
  for (const source of requiredSources) {
    assertEvidenceContains(evidence, source);
  }
