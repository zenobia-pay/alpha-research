"""Direct Modal-volume addition for HMDA 2020 snapshot ZIPs."""
...
APP_NAME = "econ-direct-hmda-2020-snapshot"
DATASET_ROOT = Path("/data/datasets/econ")
RAW_DIR = DATASET_ROOT / "raw" / "hmda_2020_snapshot"
FILES = [
    {
        "filename": "2020_public_lar_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2020/2020_public_lar_csv.zip",
        "source_key": "hmda_2020_lar",
    },
    {
        "filename": "2020_public_ts_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2020/2020_public_ts_csv.zip",
        "source_key": "hmda_2020_ts",
    },
    {
        "filename": "2020_public_msamd_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2020/2020_public_msamd_csv.zip",
        "source_key": "hmda_2020_msamd",
    },
]
...
def _download(spec: dict[str, str], destination: Path) -> dict[str, object]:
    request = Request(
        ...
        headers={
            ...
            "Referer": "https://ffiec.cfpb.gov/data-publication/snapshot-national-loan-level-dataset/2020",
        },
    )
    try:
...
def add_hmda_2020_snapshot() -> dict[str, object]:
    ...
    metadata = {
        "dataset_id": "econ",
        "source_key": "hmda_2020_snapshot",
        "title": "FFIEC/CFPB HMDA 2020 Snapshot National Loan-Level Dataset",
        "retrieved_at": retrieved_at,
...
def main() -> None:
    print(json.dumps(add_hmda_2020_snapshot.remote(), indent=2, sort_keys=True))
