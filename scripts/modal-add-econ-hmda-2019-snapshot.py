"""Direct Modal-volume addition for HMDA 2019 snapshot ZIPs."""
...
APP_NAME = "econ-direct-hmda-2019-snapshot"
DATASET_ROOT = Path("/data/datasets/econ")
RAW_DIR = DATASET_ROOT / "raw" / "hmda_2019_snapshot"
REFERER = "https://ffiec.cfpb.gov/data-publication/snapshot-national-loan-level-dataset/2019"
FILES = [
    {
        "filename": "2019_public_lar_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2019/2019_public_lar_csv.zip",
        "source_key": "hmda_2019_lar",
    },
    {
        "filename": "2019_public_ts_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2019/2019_public_ts_csv.zip",
        "source_key": "hmda_2019_ts",
    },
    {
        "filename": "2019_public_msamd_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2019/2019_public_msamd_csv.zip",
        "source_key": "hmda_2019_msamd",
    },
]
...
def add_hmda_2019_snapshot() -> dict[str, object]:
    ...
    metadata = {
        "dataset_id": "econ",
        "source_key": "hmda_2019_snapshot",
        "title": "FFIEC/CFPB HMDA 2019 Snapshot National Loan-Level Dataset",
        "retrieved_at": retrieved_at,
...
def main() -> None:
    print(json.dumps(add_hmda_2019_snapshot.remote(), indent=2, sort_keys=True))
