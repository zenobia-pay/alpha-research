export const CANONICAL_DATASETS = [
  {
    ...
    seedCandidates: [
      ...
      "- Federal Reserve ALFRED vintage time series: https://alfred.stlouisfed.org/ (active_fetchable)",
      "- Federal Reserve statistical releases H.8, H.15, G.19, and related banking/credit releases: https://www.federalreserve.gov/data.htm (active_fetchable)",
      "- FFIEC HMDA public loan-level mortgage data: https://ffiec.cfpb.gov/data-publication/ (active_fetchable)",
      "- CFPB consumer credit, mortgage, and complaint public datasets: https://www.consumerfinance.gov/data-research/ (active_fetchable)",
      "- SEC EDGAR company filings and submissions data: https://www.sec.gov/edgar/sec-api-documentation (active_fetchable)",
      "- CFTC Commitments of Traders reports: https://www.cftc.gov/MarketReports/CommitmentsofTraders/index.htm (active_fetchable)",
      "- USDA NASS Quick Stats agricultural production and price data: https://quickstats.nass.usda.gov/ (active_fetchable)",
      "- USDA ERS data products: https://www.ers.usda.gov/data-products/ (active_fetchable)",
      "- IRS Statistics of Income public data: https://www.irs.gov/statistics (active_fetchable)",
      "- Social Security Administration statistical tables and public-use files: https://www.ssa.gov/policy/docs/data/ (active_fetchable)",
      "- National Center for Education Statistics data tools and downloads: https://nces.ed.gov/datatools/ (active_fetchable)",
      "- ILOSTAT bulk labor statistics: https://ilostat.ilo.org/data/ (active_fetchable)",
      "- UN Comtrade international trade data: https://comtradeplus.un.org/ (active_fetchable)",
      "- WTO stats data portal: https://stats.wto.org/ (active_fetchable)",
      "- FAOSTAT food and agriculture data: https://www.fao.org/faostat/ (active_fetchable)",
      "- IPUMS USA/CPS public-use microdata extracts: https://www.ipums.org/ (credential_required)",
      "- ICPSR economics and social-science public-use datasets: https://www.icpsr.umich.edu/ (license_review)",
      "- CRSP/Compustat/WRDS licensed finance and firm datasets: https://wrds-www.wharton.upenn.edu/ (credential_required)",
