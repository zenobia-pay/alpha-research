"""Direct Modal-volume addition for HMDA 2017 snapshot ZIPs."""
...
APP_NAME = "econ-direct-hmda-2017-snapshot"
DATASET_ROOT = Path("/data/datasets/econ")
RAW_DIR = DATASET_ROOT / "raw" / "hmda_2017_snapshot"
REFERER = "https://ffiec.cfpb.gov/data-publication/snapshot-national-loan-level-dataset/2017"
FILES = [
    {
        "filename": "2017_public_lar_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2017/2017_public_lar_csv.zip",
        "source_key": "hmda_2017_lar",
    },
    {
        "filename": "2017_public_ts_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2017/2017_public_ts_csv.zip",
        "source_key": "hmda_2017_ts",
    },
    {
        "filename": "2017_public_msamd_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2017/2017_public_msamd_csv.zip",
        "source_key": "hmda_2017_msamd",
    },
    {
        "filename": "2017_public_panel_csv.zip",
        "url": "https://files.ffiec.cfpb.gov/static-data/snapshot/2017/2017_public_panel_csv.zip",
        "source_key": "hmda_2017_panel",
    },
]
...
def add_hmda_2017_snapshot() -> dict[str, object]:
    ...
    metadata = {
        "dataset_id": "econ",
        "source_key": "hmda_2017_snapshot",
        "title": "FFIEC/CFPB HMDA 2017 Snapshot National Loan-Level Dataset",
        "retrieved_at": retrieved_at,
...
def main() -> None:
    print(json.dumps(add_hmda_2017_snapshot.remote(), indent=2, sort_keys=True))
