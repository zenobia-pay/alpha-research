...
```text
Refresh the public dataset briefing from the mounted canonical dataset volume, verify disk inventory evidence, and write dataset_briefing.md as the source of truth for docs and CLI profile sync.
```
