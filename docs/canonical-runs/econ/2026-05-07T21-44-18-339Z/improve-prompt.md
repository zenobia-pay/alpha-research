...
```text
Economics canonical dataset expansion: improve the raw public-source package by finding and ingesting additional public machine-fetchable economics sources while preserving strict download, raw, volume inventory, briefing, docs mirror, and Slack alert contracts.
```
