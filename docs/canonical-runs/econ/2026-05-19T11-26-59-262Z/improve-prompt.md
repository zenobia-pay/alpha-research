...
```text
Refresh the public dataset briefing from the mounted canonical dataset volume; summarize scope, available fields, provenance, and practical CLI usage. Write dataset_briefing.md as the source of truth.
```
