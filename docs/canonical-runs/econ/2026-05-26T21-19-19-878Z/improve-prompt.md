...
```text
Refresh the public dataset briefing from the mounted canonical volume inventory. Write dataset_briefing.md on the dataset volume with concise coverage, schema, quality, and usage guidance grounded only in observed files.
```
