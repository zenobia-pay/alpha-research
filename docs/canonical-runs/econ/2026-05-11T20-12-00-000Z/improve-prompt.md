...
```text
Refresh the canonical public dataset briefing from the mounted dataset volume, verifying disk inventory evidence and writing dataset_briefing.md as the authoritative briefing artifact.
```
