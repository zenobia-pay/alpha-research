...
```text
Refresh the canonical economics dataset briefing from the mounted dataset volume. Produce dataset_briefing.md as the source of truth and update docs/profile mirrors.
```
