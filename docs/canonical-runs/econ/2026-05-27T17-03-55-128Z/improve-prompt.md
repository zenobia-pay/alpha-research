...
```text
Refresh the public dataset briefing and backend profile from the mounted canonical dataset volume; inventory available files, confirm representative coverage, and export dataset_briefing.md plus required validation artifacts.
```
