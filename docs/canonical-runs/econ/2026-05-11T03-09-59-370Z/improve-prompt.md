...
```text
Refresh the canonical economics dataset inventory and write an updated dataset_briefing.md that summarizes current disk contents, provenance, quality status, and remaining blockers.
```
