...
```text
Refresh the canonical public dataset briefing from the mounted dataset volume. Inventory the disk-backed dataset contents, write dataset_briefing.md on the mounted dataset volume, and keep the output concise but useful for CLI describe.
```
