...
```text
Refresh the canonical dataset briefing from the mounted dataset volume, emphasizing disk-proven inventory, coverage, record structure, notable fields, and practical research use cases. Write the final Markdown briefing to dataset_briefing.md on the mounted dataset volume.
```
