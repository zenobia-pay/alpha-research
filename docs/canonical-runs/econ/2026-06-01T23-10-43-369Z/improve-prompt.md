...
Target gap: add a compact provider-native UK Office for National Statistics labour-market source package to the raw economics substrate. Existing ONS coverage has quarterly national accounts, monthly GDP, and CPIH/CPI reference tables; labour-market releases remain a named roadmap gap.
...
- Prefer official ONS endpoints and current ONS dataset file/API URLs for labour-market overview, labour-market statistics, unemployment/employment, claimant count, earnings, vacancies, or jobs releases. Capture a compact provider-native workbook/CSV/zip package that preserves the release tables and metadata.
...
- Classify as a public-source labour/household or macro labour-market improvement.
- Do not claim this completes ONS coverage. Explicitly preserve remaining gaps such as ONS trade, productivity, balance of payments/IIP, regional accounts, Blue Book revision histories, broader ONS API/catalog coverage, and labour-market microdata.
```
