# field-definition questions use verified dataset metadata when available

## Product Use

This product test exercises the CLI behavior for `field-definition questions use verified dataset metadata when available` from the user's point of view.
