# specific viral tweets experiment blocks clearly when the named dataset is not ready

## Product Use

This product test exercises the CLI behavior for `specific viral tweets experiment blocks clearly when the named dataset is not ready` from the user's point of view.
