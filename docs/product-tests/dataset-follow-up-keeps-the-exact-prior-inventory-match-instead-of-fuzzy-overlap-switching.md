# dataset follow-up keeps the exact prior inventory match instead of fuzzy-overlap switching

## Product Use

This product test exercises the CLI behavior for `dataset follow-up keeps the exact prior inventory match instead of fuzzy-overlap switching` from the user's point of view.
