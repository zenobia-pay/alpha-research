# mixed-source intake asks for all sources and approval before any build

## Product Use

This product test exercises the CLI behavior for `mixed-source intake asks for all sources and approval before any build` from the user's point of view.
