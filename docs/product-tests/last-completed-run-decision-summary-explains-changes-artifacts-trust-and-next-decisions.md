# last completed run decision summary explains changes, artifacts, trust, and next decisions

## Product Use

This product test exercises the CLI behavior for `last completed run decision summary explains changes, artifacts, trust, and next decisions` from the user's point of view.
