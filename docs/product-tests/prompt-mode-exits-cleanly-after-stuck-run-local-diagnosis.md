# prompt mode exits cleanly after stuck-run local diagnosis

## Product Use

This product test exercises the CLI behavior for `prompt mode exits cleanly after stuck-run local diagnosis` from the user's point of view.
