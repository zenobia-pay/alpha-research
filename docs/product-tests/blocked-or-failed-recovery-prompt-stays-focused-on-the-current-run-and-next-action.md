# blocked-or-failed recovery prompt stays focused on the current run and next action

## Product Use

This product test exercises the CLI behavior for `blocked-or-failed recovery prompt stays focused on the current run and next action` from the user's point of view.
