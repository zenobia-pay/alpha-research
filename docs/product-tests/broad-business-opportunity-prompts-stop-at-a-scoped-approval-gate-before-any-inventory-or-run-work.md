# broad business-opportunity prompts stop at a scoped approval gate before any inventory or run work

## Product Use

This product test exercises the CLI behavior for `broad business-opportunity prompts stop at a scoped approval gate before any inventory or run work` from the user's point of view.
