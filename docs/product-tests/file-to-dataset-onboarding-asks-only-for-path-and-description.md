# file-to-dataset onboarding asks only for path and description

## Product Use

This product test exercises the CLI behavior for `file-to-dataset onboarding asks only for path and description` from the user's point of view.
