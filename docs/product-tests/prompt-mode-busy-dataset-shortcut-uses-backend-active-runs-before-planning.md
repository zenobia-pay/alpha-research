# prompt-mode busy dataset shortcut uses backend active runs before planning

## Product Use

This product test exercises the CLI behavior for `prompt-mode busy dataset shortcut uses backend active runs before planning` from the user's point of view.
