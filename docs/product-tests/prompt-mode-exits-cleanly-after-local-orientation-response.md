# prompt mode exits cleanly after local orientation response

## Product Use

This product test exercises the CLI behavior for `prompt mode exits cleanly after local orientation response` from the user's point of view.
