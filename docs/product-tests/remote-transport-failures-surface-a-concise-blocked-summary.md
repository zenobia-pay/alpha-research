# remote transport failures surface a concise blocked summary

## Product Use

This product test exercises the CLI behavior for `remote transport failures surface a concise blocked summary` from the user's point of view.
