# viral tweets proposal follow-up starts when the suggested dataset and scope are confirmed

## Product Use

This product test exercises the CLI behavior for `viral tweets proposal follow-up starts when the suggested dataset and scope are confirmed` from the user's point of view.
